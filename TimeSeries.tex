...
\begin{description}
     ...
     \item[\attrval{utype}{timeseries:PhotometryPoint}]\todo{Something ought to be here, if nothing else the relation of this to the fixed name.\ada{do we need it, we could drop it since there is the PARAM with the Obscore type/subtype}} \dots
\end{description}
